...
# Replace constants with config attributes
MAX_VIDEO_SIZE = config.max_video_size
MAX_AUDIO_SIZE = config.max_audio_size
MAX_TG_FILE_SIZE = config.max_tg_file_size
TELEGRAM_BOT_TOKEN = config.bot_token
ERR_LOADING_VIDEO_URL = config.err_loading_video_url
ERR_VIDEO_WIDTH = config.err_video_width
ERR_VIDEO_HEIGHT = config.err_video_height
ERR_VIDEO_DURATION = config.err_video_duration
PH_LOADING_VIDEO_URL = config.ph_loading_video_url
PH_THUMBNAIL_URL = config.ph_thumbnail_url
PH_VIDEO_WIDTH = config.ph_video_width
PH_VIDEO_HEIGHT = config.ph_video_height
PH_VIDEO_DURATION = config.ph_video_duration
MEDIA_CHAT_ID = config.media_chat_id
